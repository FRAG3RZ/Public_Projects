...
void pedal_graph_dash_init(double initial_battery_charge,
                           ...
                           int initial_lap,
                           int initial_speed, 
                           int throttle_percent, int brake_percent)
{
    ...
    prev.throttle_percent = (uint8_t)clampi(throttle_percent, 0, 100);
    prev.brake_percent = (uint8_t)clampi(brake_percent, 0, 100);
